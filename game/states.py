...
# Draw state of board based on knights and items
def board_state():
    ...
    # Print board, with separator pipes
    for line in board:
        print('|'.join(line))

# Prepare a JSON file, showing game state
def game_state():

    # Create an empty dictionary to record game state
    game_state = {}
